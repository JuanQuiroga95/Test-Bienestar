      ...
      {question.type === "texto" ? (
        <div className="space-y-3">
          <textarea
            ...
            className="w-full min-h-[120px] p-4 rounded-2xl border-2 border-white/10 bg-white/5 text-white placeholder:text-white/40 focus:border-violet-400 focus:bg-white/10 focus:outline-none transition-all duration-300 resize-none"
          />
        </div>
      ) : (
        <div className="space-y-3">
